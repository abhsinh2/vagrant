...
if [ ! -f /home/vagrant/.firsttime ]; then
    ...
    sudo kubeadm init --pod-network-cidr=192.168.0.0/16 --node-name $IP_ADDR --apiserver-cert-extra-sans=$IPADDR --apiserver-advertise-address=$IP_ADDR --ignore-preflight-errors=all
